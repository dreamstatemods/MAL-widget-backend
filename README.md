...
**$\color{blue}{\textsf{Trello version}}$** ```(index_trello.js)``` **$\color{blue}{\textsf{:}}$**
```bash
...
**$\color{blue}{\textsf{Discord version}}$** ```(index_discord.js)``` **$\color{blue}{\textsf{:}}$**
```bash
wrangler secret put DISCORD_WEBHOOK
```
Create a webhook in your server under **Server Settings → Integrations → Webhooks → New Webhook**, then copy the URL.

**$\color{blue}{\textsf{Simple version}}$** ```(index_simple.js)``` **$\color{blue}{\textsf{:}}$**
